...
imgWall2 = pygame.image.load("wall2.png")
imgDark = pygame.image.load("dark.png")
imgPara = pygame.image.load("parameter.png")
...
imgFloor = [
    ...
    pygame.image.load("tbox.png"),
    pygame.image.load("cocoon.png"),
...
imgEffect = [
    pygame.image.load("effect_a.png"),
...
def main(): #主要處理
    ...
    se = [ #音效
        pygame.mixer.Sound("ohd_se_attack.ogg"),
        pygame.mixer.Sound("ohd_se_blaze.ogg"),
        pygame.mixer.Sound("ohd_se_potion.ogg"),
        pygame.mixer.Sound("ohd_jin_gameover.ogg"),
        pygame.mixer.Sound("ohd_jin_levup.ogg"),
        pygame.mixer.Sound("ohd_jin_win.ogg")
    ]
    ...
    while True:
        ...
        if idx == 0: #標題畫面
            if tmr == 1:
                pygame.mixer.music.load("ohd_bgm_title.ogg")
            ...
            if tmr == 1:
                pygame.mixer.music.load("ohd_bgm_battle.ogg")
                pygame.mixer.music.play(-1)
                init_battle()
                init_message()
            elif tmr <= 4:
